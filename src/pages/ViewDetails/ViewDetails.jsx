            ...
            <div className='grid pt-5 lg:grid-cols-2 gap-1 grid-cols-1'>
                <div>
                    <div className='relative overflow-hidden bg-cover bg-no-repeat rounded-lg'>
                        <img className='transition duration-300 ease-in-out hover:scale-105 rounded-lg w-full' src={card.cardPhoto} alt="" /> 
                    </div>
                </div>
                <div className='grid grid-cols-2 gap-2'>
                    <div className='relative overflow-hidden bg-cover bg-no-repeat rounded-lg'>
                        <img className='transition duration-300 ease-in-out hover:scale-105 rounded-lg' src={card.photo1} alt="" /> 
                    </div>
                    <div className='relative overflow-hidden bg-cover bg-no-repeat rounded-lg'>
                        <img className='transition duration-300 ease-in-out hover:scale-105 rounded-lg' src={card.coverPhoto} alt="" />
                    </div>
                    <div className='relative overflow-hidden bg-cover bg-no-repeat rounded-lg'>
                        <img className='transition duration-300 ease-in-out hover:scale-105 rounded-lg' src={card.photo2} alt="" />
                    </div>
                    <div className='relative overflow-hidden bg-cover bg-no-repeat rounded-lg'>
                        <img className='transition duration-300 ease-in-out hover:scale-105 rounded-lg' src={card.photo3} alt="" />
                    </div>
                </div>
            </div>
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex gap-6 lg:max-w-none">
                <div className="py-8 lg:px-1 px-4 lg:flex-auto">
                    <div className=' flex justify-between'> 
                        <div>
                            <h3 className="text-2xl font-bold tracking-tight text-gray-900">{card.tourist_spot_name}</h3>
                        ...
                        <div className="">
                            <h1 className='text-2xl font-bold tracking-tight text-gray-900'>{card.price}</h1>
                        </div>
                    </div>
