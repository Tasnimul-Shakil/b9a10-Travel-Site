...
const CountryCards = () => {
    ...
    const filteredCards = data.filter(card => card.country_name === country_name);
                    ...
                    <ul>
                        <li>
                            <Link to="/" onClick={scrollToTop}>
                                <a className='flex items-center'><IoMdArrowRoundBack /> Home</a>
                            </Link>
                        </li>
                        <li>Our Property</li>
                    </ul>
