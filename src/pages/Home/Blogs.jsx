...
const Blogs = ({ card }) => {
  const { blog_id, title, time, categories, description, author_name, author_role, author_image, card_image } = card ;
  const scrollToTop = () => {
    window.scrollTo({
        top: 0,
        behavior: 'smooth' 
    ...
    return (
      <article className="card border-3 border-[#584ec2] bg-base-100 shadow-xl border-2 rounded-xl">
          <figure><img src={card_image} alt="Shoes" /></figure>
          ...
          <div className="group px-4  relative">
            ...
            <p className="pt-3 line-clamp-3 text-sm leading-6 text-gray-600">{description}</p>
          </div>
