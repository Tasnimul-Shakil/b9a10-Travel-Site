  ...
  return (
    <div className="mx-auto mt-16 mb-16 max-w-2xl sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
      <div className="-mt-2 p-2 lg:mt-0  lg:max-w-md lg:flex-shrink-0">
        ...
        >
          <h1 className="text-3xl font-semibold text-[#100A55]">
      ...
      <div className=" lg:flex-auto px-4">
        ...
        <p className="pt-4 text-base leading-7 text-gray-600">
          At Estatery, we empower you to navigate the real estate landscape with
          confidence. Our comprehensive services and commitment to transparency
          put you in control, ensuring a seamless and rewarding property
          experience.
        </p>
        <div className="grid lg:grid-cols-2 items-center gap-x-4 lg:gap-y-4 gap-y-10 pt-6 ">
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
                ...
                protecting your investment and securing assets for the future.
              </p>
            </div>
          </div>
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
                Rest assured with Estatery is commitment to competitive prices
          ...
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
                Save on costs with Estatery is transparent pricing, offering
                some of the industry is lowest rates without sacrificing quality
                service.
              </p>
            </div>
          </div>
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
                Take charge of your journey with Estatery is platform, providing
                tools for informed decision-making and ultimate control over
