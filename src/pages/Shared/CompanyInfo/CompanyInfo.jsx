        ...
        <div className="grid lg:grid-cols-2 items-center gap-x-4 lg:gap-y-4 gap-y-10 pt-6 ">
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
              Ensure peace of mind with our comprehensive solutions, protecting your journey and securing your adventures.
              </p>
            </div>
          </div>
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
              Rest assured with TourPlaner is commitment to competitive prices and maximizing value for travelers.
              </p>
            </div>
          </div>
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
              Save on costs with TourPlaner is transparent pricing, offering some of the industry’s lowest rates without sacrificing quality service.
              </p>
            </div>
          </div>
          <div className=" px-2  ">
            ...
            <div className="">
              ...
              <p className="pr-4">
              Take charge of your journey with TourPlaner is platform, providing tools for informed decision-making and ultimate control over your travel endeavors.
              </p>
            </div>
          </div>
        </div>
