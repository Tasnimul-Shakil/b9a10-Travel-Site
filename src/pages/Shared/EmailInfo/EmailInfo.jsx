const EmailInfo = () => {
  return (
    <div className=" text-center px-4 items-center rounded-lg py-16 bg-[#100A55] ">
      <h2 className=" text-xl text-[#7065F0] font-semibold pt-6">
        No Spam Promise
      </h2>
      ...
      <div className="join pt-10">
        <input
          ...
          placeholder="Email"
        />
        <button className="btn join-item border-0 font-semibold text-white bg-[#7065F0] hover:bg-[#55D4AB] hover:text-black">
          Submit
        </button>
      </div>
