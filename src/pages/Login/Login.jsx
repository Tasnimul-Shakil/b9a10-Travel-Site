                    ...
                    <form onSubmit={handleLogin} className="">
                        ...
                        <div className='pt-10'>
                            ...
                            <div className="mb-6 flex gap-5">
                                <button onClick={()=>handleGoogleLogin()} className="btn btn-outline mt-3">
                                    <FcGoogle className="text-xl"></FcGoogle>
                                    Google
                                </button>
                                <button onClick={()=>handleGitLogin()} className="btn btn-outline mt-3">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn border-0 text-xl text-white bg-[#7065F0] hover:bg-[#cce65b] hover:text-black">Login</button>
                        </div>
                    </form>
                    <div className="pt-10">
